  ...
  getMaps(): Observable<MapDetails[]> {
    return this.http.get<MapDetails[]>('https://eyxrmhvbutmdcycshzni.supabase.co/rest/v1/zones', {
      headers: {
        ...
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiIsImtpZCI6IkJxTGpaTjM0K0Y3c2U4bkYiLCJ0eXAiOiJKV1QifQ..l_PQcF3T6iuF9lgiSqG4fW6dEYygImgAFJkS_I2NIbM',
      },
    });
  }
